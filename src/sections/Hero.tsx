  ...
  return (
    ...
    <HeroOrbit size={520} rotation={-20}>
      ...
      <div className="container">
        ...
        <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide">Building Exceptional User Experciences</h1>
        <p className="mt-4 text-center text-white/60 md:text-lg">
          I specialize in transforming desgins into functional, high-performing
