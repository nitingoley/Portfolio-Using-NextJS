...
export const ContactSection = () => {
  return (
    <div className="py-16 lg:py-24 lg:pt-20 pt-14" id="contact">
      <div className="container">
        <div className="bg-gradient-to-r from-emerald-300 to-sky-400 relative overflow-hidden z-0 text-gray-950 py-8 px-10 text-center md:text-left rounded-3xl">
